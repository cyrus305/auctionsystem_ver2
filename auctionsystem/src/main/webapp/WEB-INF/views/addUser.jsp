...
<body> 
	<section class="container">
		<form:form modelAttribute="addUser" action="addUser" method="post" class="form-horizontal" >
			<fieldset>
				<legend>New User</legend>

				<form:errors path="*" cssClass="alert alert-danger" element="div" />
<!-- 				<div class="form-group"> -->
<!-- 					<label class="control-label col-lg-2 col-lg-2" for="userNumber"> -->
<!-- 						User Number</label> -->
<!-- 					<div class="col-lg-10"> -->
<%-- 						<form:input id="userNumber" path="userNumber" type="text" --%>
...
<!-- 				</div> -->
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<div class="form:input-prepend">
							<form:input id="password" path="credentials.password" type="password"
								class="form:input-large" />
