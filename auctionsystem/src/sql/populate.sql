...
INSERT INTO address (street,city,state,zipcode) VALUES ('guest','guest','guest','guest');
INSERT INTO user (firstName, lastName, email, userNumber, addressid, credentialsid) VALUES ('guest','guest','guest@guest.com',2,2,2);

INSERT INTO categories(id, name, description) VALUES (null, 'Electrnoics', 'electronic goods');

INSERT INTO tbl_product(product_id, description,  minBiddingPrice, name, timetobid, category_id) values (null,'very good phone',  200, 'iPhone 6s Plus','2012-2-2', 1);
